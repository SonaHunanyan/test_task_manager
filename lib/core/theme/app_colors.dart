...
class AppColors {
  ...
  static const Color secondary = Color(0xff6C46FE);
  static const Color mail = Color(0xff0E0042);
  static const Color longTextColor = Color(0xff443971);
  static const Color strokColor = Color(0xffE7E7E7);
  static const Color softPurple = Color(0xffD3C7FF);
